...
public class Info5001UniversityExample {
    ...
    public static void main(String[] args) {
        ...
        Course elective1 = courseCatalog.newCourse("Cloud Computing", "INFO5110", 4);
        Course elective2 = courseCatalog.newCourse("Machine Learning", "INFO5111", 4);
        Course elective3 = courseCatalog.newCourse("Cybersecurity", "INFO5200", 4);
        Course elective4 = courseCatalog.newCourse("Web Development ", "INFO5220", 4);
        Course elective5 = courseCatalog.newCourse("Data Visualization", "INFO5222", 4);
        ...
        FacultyProfile faculty2 = facultyDirectory.newFacultyProfile(new Person("Prof. Andrew Tate"));
        FacultyProfile faculty3 = facultyDirectory.newFacultyProfile(new Person("Prof. Siddhant Wardhewar "));
        FacultyProfile faculty4 = facultyDirectory.newFacultyProfile(new Person("Prof. Mike Tyson"));
        FacultyProfile faculty5 = facultyDirectory.newFacultyProfile(new Person("Prof. Muhammad Ali"));
        FacultyProfile faculty6 = facultyDirectory.newFacultyProfile(new Person("Prof. Flyod Mayweather"));
